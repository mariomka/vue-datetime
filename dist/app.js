...
(function (global, factory) {
  ...
  function monthDays(year, month) {
    ...
    return new Array(monthDate.daysInMonth + firstDay).fill(null).map(function (value, index) {
  ...
  function weekdays() {
    return luxon.Info.weekdays('short').map(function (weekday) {
  ...
  var DatetimeCalendar = { render: function render() {
    ...
    computed: {
      ...
      days: function days() {
        ...
        return monthDays(this.newYear, this.newMonth).map(function (day) {
          return {
            number: day,
  ...
  var DatetimeTimePicker = { render: function render() {
      var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "vdatetime-time-picker" }, [_c('div', { ref: "hourList", staticClass: "vdatetime-time-picker__list vdatetime-time-picker__list--hours" }, _vm._l(_vm.hours, function (hour) {
    ...
    computed: {
      hours: function hours$1() {
        ...
        return hours(this.hourStep).map(function (hour) {
          return {
            number: pad(hour),
  ...
  var DatetimeYearPicker = { render: function render() {
      var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "vdatetime-year-picker" }, [_c('div', { ref: "yearList", staticClass: "vdatetime-year-picker__list vdatetime-year-picker__list" }, _vm._l(_vm.years, function (year) {
        return _c('div', { staticClass: "vdatetime-year-picker__item", class: { 'vdatetime-year-picker__item--selected': year.selected }, on: { "click": function click($event) {
  ...
  var Datetime = { render: function render() {
      var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "vdatetime" }, [_c('input', _vm._g(_vm._b({ staticClass: "vdatetime-input", class: _vm.inputClass, attrs: { "type": "text" }, domProps: { "value": _vm.inputValue }, on: { "click": _vm.open, "focus": _vm.open } }, 'input', _vm.$attrs, false), _vm.$listeners)), _vm._v(" "), _c('transition-group', { attrs: { "name": "vdatetime-fade", "tag": "div" } }, [_vm.isOpen ? _c('div', { key: "overlay", staticClass: "vdatetime-overlay", on: { "click": function click($event) {
            if ($event.target !== $event.currentTarget) {
              return null;
            }_vm.cancel($event);
          } } }) : _vm._e(), _vm._v(" "), _vm.isOpen ? _c('datetime-popup', { key: "popup", attrs: { "type": _vm.type, "datetime": _vm.popupDate, "phrases": _vm.phrases, "hour-step": _vm.hourStep, "minute-step": _vm.minuteStep, "min-datetime": _vm.popupMinDatetime, "max-datetime": _vm.popupMaxDatetime, "auto": _vm.auto }, on: { "confirm": _vm.confirm, "cancel": _vm.cancel } }) : _vm._e()], 1)], 1);
    }, staticRenderFns: [],
    components: {
    ...
    watch: {
      value: function value(newValue) {
        var date = luxon.DateTime.fromISO(newValue).toUTC();
    ...
    computed: {
      ...
      popupDate: function popupDate() {
        return this.date ? this.date.setZone(this.zone) : luxon.DateTime.utc().setZone(this.zone);
      },
    ...
    methods: {
      emitInput: function emitInput() {
        var date = this.date ? this.date.setZone(this.valueZone) : null;
