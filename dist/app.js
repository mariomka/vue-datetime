...
(function (global, factory) {
  ...
  var DatetimeTimePicker = { render: function render() {
      var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "vdatetime-time-picker" }, [_c('div', { ref: "hourList", staticClass: "vdatetime-time-picker__list vdatetime-time-picker__list--hours" }, _vm._l(_vm.hours, function (hour) {
        return _c('div', { staticClass: "vdatetime-time-picker__item", class: { 'vdatetime-time-picker__item--selected': hour.selected }, on: { "click": function click($event) {
        ...
        return _c('div', { staticClass: "vdatetime-time-picker__item", class: { 'vdatetime-time-picker__item--selected': minute.selected }, on: { "click": function click($event) {
  ...
  var DatetimePopup = { render: function render() {
      var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "vdatetime-popup" }, [_c('div', { staticClass: "vdatetime-popup__header" }, [_c('div', { staticClass: "vdatetime-popup__year" }, [_vm._v(_vm._s(_vm.year))]), _vm._v(" "), _c('div', { staticClass: "vdatetime-popup__date" }, [_vm._v(_vm._s(_vm.dateFormatted))])]), _vm._v(" "), _c('div', { staticClass: "vdatetime-popup__body" }, [_vm.step === 'date' ? _c('datetime-calendar', { attrs: { "year": _vm.year, "month": _vm.month, "day": _vm.day }, on: { "change": _vm.onChangeDate } }) : _vm._e(), _vm._v(" "), _vm.step === 'time' ? _c('datetime-time-picker', { attrs: { "hour": _vm.hour, "minute": _vm.minute }, on: { "change": _vm.onChangeTime } }) : _vm._e()], 1), _vm._v(" "), _c('div', { staticClass: "vdatetime-popup__actions" }, [_c('div', { staticClass: "vdatetime-popup__actions__button vdatetime-popup__actions__button--cancel", on: { "click": _vm.cancel } }, [_vm._v(_vm._s(_vm.i18n.cancel))]), _vm._v(" "), _c('div', { staticClass: "vdatetime-popup__actions__button vdatetime-popup__actions__button--confirm", on: { "click": _vm.confirm } }, [_vm._v(_vm._s(_vm.i18n.ok))])])]);
    }, staticRenderFns: [],
    components: {
  ...
  var Datetime = { render: function render() {
      var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "vdatetime", class: _vm.wrapperClass }, [_c('input', _vm._g(_vm._b({ staticClass: "vdatetime-input", class: _vm.inputClass, attrs: { "type": "text" }, domProps: { "value": _vm.inputValue }, on: { "click": _vm.open, "focus": _vm.open } }, 'input', _vm.$attrs, false), _vm.$listeners)), _vm._v(" "), _c('transition', { attrs: { "name": "vdatetime-fade" } }, [_vm.isOpen ? _c('div', [_c('div', { staticClass: "vdatetime-overlay", on: { "click": function click($event) {
            if ($event.target !== $event.currentTarget) {
              return null;
            }_vm.cancel($event);
          } } }), _vm._v(" "), _c('datetime-popup', { attrs: { "type": _vm.type, "datetime": _vm.popupDate }, on: { "confirm": _vm.confirm, "cancel": _vm.cancel } })], 1) : _vm._e()])], 1);
    }, staticRenderFns: [],
    components: {
